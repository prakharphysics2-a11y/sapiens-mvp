...
# --- Configuration ---
# CORRECTED PATH to match your Render Persistent Disk setup
...
def download_model_if_needed(url, dest_path):
    ...
    # --- FIX: DO NOT CREATE THE DIRECTORY. RENDER PROVIDES IT. ---
    # os.makedirs(dest_dir, exist_ok=True)
    # --- END OF FIX ---

    # Instead, just check if the directory exists
    if not os.path.exists(dest_dir):
        logger.error(f"❌ CRITICAL: The mount path '{dest_dir}' does not exist. Check your Render Disk settings.")
        return False
...
# This logic will be triggered by app.py
...
# --- get_model_info function remains the same ---
def get_model_info():
    # ... (code for get_model_info) ...
    pass
